...
import com.learn.stateless.security.UserAuthentication;
...
public class UserController {
    ...
    public Object find(@PathVariable Integer id) {
        ...
        return user; //anonymous user support
    }

    @RequestMapping(value = "/secure/api/users/current", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/secure/api/users/current", method = RequestMethod.PATCH)
